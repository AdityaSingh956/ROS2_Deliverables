...
class SpiralMotionGazebo(Node):

    def __init__(self):
        super().__init__('spiral_motion_gazebo')
        ...
        self.get_logger().info("TurtleBot will start forming spiral shape")
        self.radius = 2.0
        self.pose_x = 0.0
        self.pose_y = 0.0
...
def main(args=None):
    ...
    spiral_motion_gazebo = SpiralMotionGazebo()
    rclpy.spin(spiral_motion_gazebo)
    rclpy.shutdown()
